...
//             }
//         } else {
//             console.warn('[SSE Context] 브라우저가 알림을 지원하지 않음');
//         }
//         return null;
//     }, []);
//
...
//                 console.log('[SSE Context] 알림 수신 데이터:', data);
//
//                 // 알림 객체에 수신 시간 추가
//                 const alarmWithTime = {
//                     ...data,
...
//                 };
//
//                 // 기존 알림과 새 알림을 합쳐서 최신순으로 정렬
//                 setAlarms((prevAlarms) => {
//                     console.log('[SSE Context] 이전 알림 개수:', prevAlarms.length);
//
//                     // 새로운 알림을 맨 앞에 추가 (최신순)
//                     const newAlarms = [alarmWithTime, ...prevAlarms].slice(0, 100); // 최대 100개 유지
//
...
//                     } catch (error) {
//                         console.error('[SSE Context] 콜백 실행 오류:', error);
//                     }
//                 }
//             };
//
...
//                 }
//             };
//         }, [sseManager, formatDateTime, showNotification])
//     };
//
//     return (
